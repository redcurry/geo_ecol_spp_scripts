...
def genetic_distance(genotype, set_1, set_2):
  if len(set_2) == 0:
    return 'NA'

# STILL WORKING ON THIS...

  positions = set_1 | set_2
...
for line in sys.stdin:
  ...
  if count % 2 == 1:
    ...
    print genetic_distance(genotype, prev_muts_1, muts_1), \
          genetic_distance(genotype, prev_muts_2, muts_2)
